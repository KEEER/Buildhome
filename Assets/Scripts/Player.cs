...
public class Player : MonoBehaviour {
    ...
    private OverallTileManager overallManagerHandle;
    private SmoothFollow followerHandle;
    public GameObject managerObject,cameraObject;
    private int shield;
    ...
    private void updateLogic()
    {
        ...
        if(snakeBody.Count > 3)
            followerHandle.updateSize((int)(snakeBody.Count * 0.3f) + 10);
        else followerHandle.updateSize(10);
    }
